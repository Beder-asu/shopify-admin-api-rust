...
pub struct AbandonedCheckoutListParams {
    #[serde(skip_serializing_if = "Option::is_none")]
...
struct CheckoutsWrapper { checkouts: Vec<AbandonedCheckout> }

impl AbandonedCheckout {
    pub async fn all(client: &Client, params: AbandonedCheckoutListParams) -> Result<FindAllResponse<Self>> {
